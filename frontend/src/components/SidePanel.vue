  ...
  <aside v-if="store.meta" class="side-panel">
    ...
    <div class="panel-section">
      ...
      <div class="asset-buttons">
        ...
        <button @click="handleAddDay" class="btn-asset day">+ Dzień</button>
      </div>
      ...
      <div class="asset-category">
        ...
        <div v-if="sectionsOpen.av" class="asset-list av-list">
          ...
          <div v-if="!avatarAssets.length" class="empty">Brak avatarów - dodaj w Konfiguruj Janusza</div>
        </div>
      </div>
    </div>
...
<style scoped>
.side-panel{width:280px;min-width:280px;height:100%;background:#0D1117;border-right:1px solid #21262D;display:flex;flex-direction:column;gap:16px;padding:12px;overflow-y:auto;box-sizing:border-box}
...
.btn-asset.day{border-color:rgba(0,255,148,0.3)}
